...
def render(font_path: Path, output: Path) -> None:
    ...
    sections = [
        ...
        ("МАРИЙСКИЕ БУКВЫ · ЛУГОВОЙ И ГОРНЫЙ", "Ӓ ӓ   Ӧ ӧ   Ӱ ӱ   Ӹ ӹ   Ҥ ҥ", 64),
        ("ЛАТИНИЦА", "ABCDEFGHIJKLMNOPQRSTUVWXYZ\nabcdefghijklmnopqrstuvwxyz · Straße", 46),
    ...
    draw_text(draw, (MARGIN, HEIGHT - 110), f"Tishte Serif · {version_label} · SIL OFL 1.1", font(font_path, 24), MUTED)
