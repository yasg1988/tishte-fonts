...
Собрано связанное инженерное семейство Tishte Serif v0.070: Regular, Bold,
...
маску валидации FontForge. Полная оригинализация всё ещё требуется до релиза.
Нормативные и продуктовые требования зафиксированы в каталоге `docs/`.

Повторный корпус Microsoft Word v0.070 полностью совпал в пяти парах по числу
