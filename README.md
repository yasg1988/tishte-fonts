...
Собрано связанное инженерное семейство Tishte Serif v0.080: Regular, Bold,
Italic и Bold Italic. Каждое начертание содержит 216 обязательных символов,
...
маску валидации FontForge. v0.080 добавляет явный контроль обычного и
неразрывного пробела и корректный HarfBuzz-аудит по письменностям. Полная
